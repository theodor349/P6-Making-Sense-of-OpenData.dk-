...
namespace LabelRecognizer.Tests.Labeling.GeoTests
{
    ...
    public class GeoTests
    {
        ...
        public void LabelGenerator_Coordinate_Correct()
        {
            ...
            // Assert 
            var res = inputDataset.Objects[0].Attributes[0].Labels.FirstOrDefault(x => x.Label == ObjectLabel.Coordinate);
        ...
        public void LabelGenerator_PolygonCoordinates_Correct()
        {
            ...
            var res1 = coordinates.Labels.FirstOrDefault(x => x.Label == ObjectLabel.Coordinate);
            res1.Should().BeNull();
            // Coord 1 flagged as Coordinate
            var res2 = coordinateList[0].Labels.FirstOrDefault(x => x.Label == ObjectLabel.Coordinate);
            res2.Should().NotBeNull();
            // Coord 2 flagged as Coordinate
            var res3 = coordinateList[1].Labels.FirstOrDefault(x => x.Label == ObjectLabel.Coordinate);
        ...
        public void LabelGenerator_CoordinateWithText_Correct()
        {
            ...
            var res = ((List<ObjectAttribute>)inputDataset.Objects[0].Attributes[0].Value)[1].Labels.FirstOrDefault(x => x.Label == ObjectLabel.Coordinate);
            res.Should().NotBeNull();
        }
